              ...
              <div className="relative w-[85%] h-[85%] mx-auto">
                ...
                >
                  ...
                  <div className="flex flex-col items-center">
                    <h2 className="text-xl sm:text-2xl md:text-3xl text-white font-iqos text-center mb-6 sm:mb-8 md:mb-10">
                      {selectedMachine ? formatModelName(selectedMachine.baseModel) : ''}
                    </h2>

                    <div className="mt-6 sm:mt-8 md:mt-10 flex justify-center items-start gap-8 sm:gap-10 md:gap-12">
