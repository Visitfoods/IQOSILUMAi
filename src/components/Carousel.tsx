...
const machines: Machine[] = [
  ...
  { id: 2, name: "ILUMAi ONE", image: "/IMG/ILUMAi/ILUMAi_ONE.png", baseModel: "ILUMAi-ONE" },
  { id: 3, name: "ILUMAi PRIME", image: "/IMG/ILUMAi/ILUMAi_PRIME.png", baseModel: "ILUMAi-PRIME" },
];
